  ...
  return (
    <div className="animate-fade-in space-y-6">
      <div>
        ...
        <p className="text-gray-400 text-sm">Chat directly with employers about jobs you've applied to.</p>
      </div>
      ...
      <div className="text-center py-20 bg-gray-900/30 rounded-2xl border border-gray-800 border-dashed">
        ...
        <h3 className="text-lg font-medium text-gray-300 font-semibold">No active conversations</h3>
