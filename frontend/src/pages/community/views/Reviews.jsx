...
const Reviews = ({ user }) => {
  ...
  return (
    <div className="space-y-6 animate-fade-in font-sans">
      <div>
        <h2 className="text-2xl font-bold text-[#06402B] mb-2">Reviews Feed</h2>
              ...
              >
                  ...
                  <div>
                    ...
                    <div className="text-[10px] text-gray-500 mt-2 bg-gray-50/60 p-2 rounded border border-gray-850 space-y-1">
                      ...
                      <div className="flex flex-col gap-0.5">
                        <span className="text-gray-600 font-semibold text-[11px]">{partner?.name || 'Unknown User'}</span>
                        <span className="text-gray-500 font-mono text-[9px]">{partner?.email || 'N/A'}</span>
                      </div>
                    </div>
                  </div>
                ...
                {review.job && (
                  <div className="flex justify-between items-center text-[10px] text-gray-500 pt-2 border-t border-gray-200/60">
                    ...
                    <span className="text-green-600 font-bold">LKR {review.job.payAmount || 'N/A'}</span>
                  </div>
                )}
              </div>
            );
