...
const Footer = () => {
  return (
    <footer className="bg-gray-900 border-t border-gray-800 text-gray-400 py-12 select-none">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <span className="text-lg font-bold text-white tracking-wider">WorkOra</span>
          </div>
        ...
        <div className="space-y-3">
          <h4 className="text-xs font-bold text-white uppercase tracking-wider">Direct Office</h4>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 pt-6 border-t border-gray-800 text-center text-xs text-gray-600 flex flex-col sm:flex-row justify-between items-center gap-4">
        <span>&copy; {new Date().getFullYear()} WorkOra Platform. All rights reserved.</span>
        <div className="flex gap-4">
          <span className="hover:text-gray-400 transition cursor-pointer">Facebook</span>
          <span className="hover:text-gray-400 transition cursor-pointer">Twitter</span>
          <span className="hover:text-gray-400 transition cursor-pointer">LinkedIn</span>
        </div>
      </div>
    </footer>
  );
